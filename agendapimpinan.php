            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Daftar Agenda Pimpinan</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Data Table Agenda Pimpinan</h6>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" style="font-size: .8rem;">
                                    ...
                                    <tbody>
                                        <?php
                                        $no = 1;
                                        $tampil = mysqli_query($koneksi, "SELECT * FROM agenda_pimpinan ORDER BY id_pimpinan ASC");
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel">Form Edit Data Agenda Pimpinan</h5>
                                                            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                                                                <span aria-hidden="true">×</span>
                                                            </button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <form method="POST" id="formEditBarang" action="prosespimpinan.php">
                                                                <input type="hidden" name="id_pimpinan" value="<?= $data['id_pimpinan'] ?>">
                                                        ...
                                                        <div class="modal-body">
                                                            <form method="POST" id="formEditBarang" action="prosespimpinan.php">
                                                                ...
                                                                <h5 class="text-center">Apakah Anda yakin Menghapus Data ini?
                                                                    <br>
                                                                    <span class="text-danger"><?= $data['nama_pimpinan'] ?> - <?= $data['hari'] ?> - <?= $data['kegiatan'] ?> - <?= $data['ruangan'] ?></span>
                                                                </h5>
                                                                <br>
