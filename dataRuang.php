...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Daftar Ruang</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Data Table Ruang</h6>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" style="font-size: .8rem;">
                                    ...
                                    <tbody>
                                        <?php
                                        $no = 1;
                                        $tampil = mysqli_query($koneksi, "SELECT * FROM dataruang ORDER BY id_dataruang ASC");
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel">Form Edit Data Ruang</h5>
                                                            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                                                                <span aria-hidden="true">×</span>
                                                            </button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <form method="POST" id="formEditBarang" action="proses.php">
                                                                <input type="hidden" name="id_dataruang" value="<?= $data['id_dataruang'] ?>">
                                                        ...
                                                        <div class="modal-body">
                                                            <form method="POST" id="formEditBarang" action="proses.php">
                                                                ...
                                                                <h5 class="text-center">Apakah Anda yakin Menghapus Data ini?
                                                                    <br>
                                                                    <span class="text-danger"><?= $data['hari'] ?> - <?= $data['kegiatan'] ?> - <?= $data['ruangan'] ?></span>
                                                                </h5>
                                                                <br>
    ...
    <div class="modal fade" id="tambahModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Form Tambah Data Ruang</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form method="POST" id="formTambahBarang" action="proses.php">
                        <label for="hari">Pilih Hari:</label><br>
                        <select class="form-control" aria-label="Default select example" id="hari" name="hari">
